...
public class NetworkUtils {
    ...
    private static final String API_KEY = "eee5aa5006c2dabed22c18ba6af6fc6f";
    //                                     eee5aa5006c2dabed22c18ba6af6fc6f
    //                                     45a0637cc418d9659b31c744075e0c9b
    //                                     3811dffbd8bc87f702dad54554f272a9
    ...
    public static URL buildURLToReviews(int id, String lang) {
        Uri uri = Uri.parse(String.format(BASE_URL_REVIEWS, id)).buildUpon()
                .appendQueryParameter(PARAMS_API_KEY, API_KEY)
                .appendQueryParameter(PARAMS_API_KEY, lang)
                .build();
        try {
            return new URL(uri.toString());
        } catch (MalformedURLException e) {
    ...
    public static class JSONLoader extends AsyncTaskLoader<JSONObject> {
        ...
        public JSONObject loadInBackground() {
            ...
            String urlAsString = bundle.getString("url_key");
            URL url = null;
            try {
